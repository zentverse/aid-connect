...
export const RequestAidPage: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Request Aid</h1>
        <p className="text-slate-500">Provide details about your situation and requirements.</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  type="text"
                  className={`w-full bg-white text-slate-900 rounded-lg border p-2.5 focus:ring-2 outline-none transition-colors ${
                    errors.fullName 
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">NIC / ID Number *</label>
                <input
                  name="nic"
                  value={formData.nic}
                  onChange={handleInputChange}
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Other Contact Number <span className="text-slate-400 font-normal">(Optional)</span></label>
                <input
              ...
              <div className="col-span-1 md:col-span-2 grid md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">Region / Division *</label>
                  <select
                    value={selectedRegion}
                    onChange={handleRegionChange}
                    disabled={!selectedDistrict}
                    className={`w-full bg-white text-slate-900 rounded-lg border p-2.5 focus:ring-2 outline-none transition-colors disabled:opacity-50 disabled:bg-slate-100 ${
                      errors.region 
                        ? 'border-red-500 focus:ring-red-200 focus:border-red-500' 
                        : 'border-slate-300 focus:ring-blue-500 focus:border-blue-500'
                    }`}
                  >
                   ...
                   <p className="text-xs text-slate-500 mt-1">If your Region / Division is not listed, select the closest available.</p>
                </div>
              </div>
          ...
          <section className="space-y-4">
            <div className="flex justify-between items-center border-b pb-2">
              <h3 className="text-lg font-semibold text-slate-800">Required Items *</h3>
              <button
                type="button"
                onClick={addItem}
                  ...
                  <div className="flex flex-col md:flex-row gap-3 items-start md:items-start mb-3">
                    ...
                    <div className="flex-1 w-full">
                      ...
                      <input
                        ...
                        className={`w-full bg-white text-slate-900 rounded border p-2 text-sm outline-none ${
                  ...
                  <div className="mt-2 pl-1">
                     <div className="flex items-center gap-2 mb-2">
                        <span className="text-xs font-medium text-slate-500 flex items-center gap-1">
                          <i className="fa-solid fa-tags"></i> Related Keywords
                        </span>
                     ...
                     <div className="flex flex-wrap gap-2">
                        {item.keywords && item.keywords.length > 0 ? (
                          ...
                          !keywordLoaders[item.id] && <span className="text-xs text-slate-400 italic">Enter item name to generate tags...</span>
                        )}
                     </div>
                  </div>
                </div>
          ...
          <section>
             ...
             <textarea
               ...
               placeholder="Any specific details like directions or medical conditions..."
             />
          </section>
